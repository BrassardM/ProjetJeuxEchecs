...
gameInterface::TempMove::TempMove(std::pair<int, int> originalPos, std::pair<int, int> stealpos, Board* input) : originalPos_(originalPos), movePos_(stealpos), board_(input)
{
...
gameInterface::TempMove::~TempMove()
{
